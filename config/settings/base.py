...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///guru")}
...
MIGRATION_MODULES = {"sites": "guru.contrib.sites.migrations"}
...
TEMPLATES = [{
    ...
    "OPTIONS": {
        ...
        "context_processors": [
            ...
            "guru.utils.context_processors.settings_context",
        ],
    },
}]
...
ADMINS = [("""Francis, Jarquevious, Jerome, Jonasz""", "jonaszakr@gmail.com")]
